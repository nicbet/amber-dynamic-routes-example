# amber_dynamic_routes

amber_dynamic_routes is a new project using [Amber Framework](https://amberframework.org/)
...
```
shards build --production --release amber_dynamic_routes
```
...
1. Fork it ( https://github.com/your-github-user/amber_dynamic_routes/fork )
...
- [your-github-user](https://github.com/your-github-user) Nicolas Bettenburg - creator, maintainer
